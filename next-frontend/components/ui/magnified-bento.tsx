...
const MagnifiedBento = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full not-prose p-0 m-0">
      <div className="group relative w-full h-full overflow-hidden rounded-xl bg-transparent transition-all duration-500">
        <div
          ref={containerRef}
          className={cn(
            "relative w-full h-full overflow-hidden bg-muted/30 min-h-[200px] sm:min-h-[240px]",
          )}
        >
